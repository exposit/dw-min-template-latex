...
% allows non-engilish characters, and stops greater then or less then signs causing errors in the text.
\usepackage[T1]{fontenc}

% allows different hypenation ules to be accomadated
\usepackage [english]{babel}

% manages the style for quotation marks " "
\usepackage [autostyle, english = american]{csquotes}
\MakeOuterQuote{"}

% supports variable width minipages used to layout the character sheet
%\usepackage{varwidth}

% Controls layout of lists and bullet points  - needed to keep them tight
\usepackage{enumitem}

%\usepackage{datetime}

% lots of math symbols, here used for full and empty circle and square markers for move tracking.
\usepackage{amssymb}

% used for abosulte text positioning. Dynamic generation is the goal
\usepackage[absolute]{textpos}

% sets the grid size used by the textpos package
